...
| 04-05 | [PRD와 Taskmaster](./04-core-features/04-05-prd-taskmaster.md) | PRD 워크플로우, taskmaster 커맨드, 자율 실행 연동 | 2 |
...
| 09 | [사람이 읽기 쉬운 코드 원칙](./09-readable-code-principles.md) | 가독성 우선 원칙, 리뷰 기준, AI 작성 규칙 | 1 |

## 추천 읽기 순서

1. 첫날: 01 → 03 → 08
2. 첫주: 02 → 05 → 06
3. 심화: 04-01 → 04-02 → 04-03 → 04-04 → 04-05
4. 커스터마이징 시: 07
...
- 구성: Rules 4개 / Commands 20개 / Skills 40개 / Agents 18개+빌트인 / Hooks 6개
